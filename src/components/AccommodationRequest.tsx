...
const AccommodationRequest: React.FC<AccommodationRequestProps> = ({ onCancel }) => {
  const employeeInfo = {
    name: 'Johnathan Doe',
    id: 'EMP-10294',
  ...
  return (
    <div id="accommodation-request-form" className="w-full max-w-[700px] mx-auto py-4">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-olive-light rounded-button flex items-center justify-center text-olive">
            <Home size={20} />
          </div>
          <h1 className="text-xl font-bold text-text-primary uppercase tracking-widest">Accommodation Request</h1>
        </div>
        <button 
          onClick={onCancel}
      ...
      <div className="enterprise-card bg-white space-y-10 shadow-sm">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-50">
            ...
            <h2 className="text-xs font-bold text-text-secondary uppercase tracking-widest">Accommodation Details</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Accommodation Type</label>
            ...
            <div className="sm:col-span-2">
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Location</label>
              <input type="text" className="input-field w-full" placeholder="Specify city or branch location" />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Check-in Date</label>
            ...
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Check-out Date</label>
              <div className="relative">
                <input type="date" className="input-field w-full pl-10" />
                <Calendar size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
              </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-50">
            ...
            <h2 className="text-xs font-bold text-text-secondary uppercase tracking-widest">Stay Details</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <input type="number" className="input-field w-full" min="1" placeholder="0" />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Number of People</label>
              <input type="number" className="input-field w-full" min="1" defaultValue="1" />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Room Type</label>
              <select className="input-field w-full appearance-none bg-[url('data:image/svg+xml;base64,')] bg-[length:16px] bg-[right_12px_center] bg-no-repeat">
        ...
        <section className="space-y-2">
          <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-widest mb-1">Purpose of Stay</label>
          <textarea className="input-field w-full min-h-[100px] resize-none" placeholder="Reason for accommodation request..."></textarea>
        </section>
        ...
        <section className="pt-4">
          <label className="flex items-center gap-3 cursor-pointer select-none group">
            ...
            <span className="text-sm text-text-secondary font-medium group-hover:text-text-primary transition-colors">I confirm that this accommodation request is for official purposes.</span>
          </label>
        </section>
