...
const ApplyLeave: React.FC<ApplyLeaveProps> = ({ onCancel }) => {
  const employeeInfo = {
    name: 'Johnathan Doe',
    id: 'EMP-10294',
  ...
  return (
    <div id="apply-leave-form" className="w-full max-w-[700px] mx-auto py-4">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-olive-light rounded-button flex items-center justify-center text-olive">
            <Calendar size={20} />
          </div>
          <h1 className="text-xl font-bold text-text-primary uppercase tracking-widest">Apply Leave</h1>
        </div>
        <button 
          onClick={onCancel}
      ...
      <div className="enterprise-card bg-white space-y-10 shadow-sm">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-50">
            ...
            <h2 className="text-xs font-bold text-text-secondary uppercase tracking-widest">Leave Details</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Leave Type</label>
            ...
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">From Date</label>
              <input type="date" className="input-field w-full" />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">To Date</label>
              <input type="date" className="input-field w-full" />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Number of Days</label>
              <input type="text" className="input-field w-full bg-gray-50" placeholder="0" readOnly />
            </div>
          </div>
        </section>
        ...
        <section className="space-y-2">
          <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-widest mb-1">Reason for Leave</label>
          <textarea className="input-field w-full min-h-[100px] resize-none" placeholder="Enter reason for leave..."></textarea>
        </section>

        {/* 4. Contact Details During Leave */}
        <section className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-50">
            <Phone size={16} className="text-olive" />
            <h2 className="text-xs font-bold text-text-secondary uppercase tracking-widest">Contact Details During Leave</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Contact Number</label>
              <input type="text" className="input-field w-full" placeholder="+1 (555) 000-0000" />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Alternative Contact / Email</label>
              <input type="text" className="input-field w-full" placeholder="email@example.com" />
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 pb-2 border-b border-gray-50">
            ...
            <h2 className="text-xs font-bold text-text-secondary uppercase tracking-widest">Work Handover</h2>
          </div>
          <div className="space-y-4">
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Handover To</label>
              <input type="text" className="input-field w-full" placeholder="Employee name or ID..." />
            </div>
            <div>
              <label className="block text-[10px] font-bold text-text-secondary uppercase tracking-tighter mb-1">Handover Notes</label>
              <textarea className="input-field w-full min-h-[80px] resize-none" placeholder="Important tasks or instructions for the handover..."></textarea>
            </div>
          </div>
        </section>
        ...
        <section className="pt-4">
          <label className="flex items-center gap-3 cursor-pointer select-none group">
            ...
            <span className="text-sm text-text-secondary font-medium group-hover:text-text-primary transition-colors">I confirm that the above information is correct.</span>
          </label>
        </section>
